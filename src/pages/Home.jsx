...
import { FaGithub, FaLinkedin, FaEnvelope, FaArrowRight, FaDocker, FaPython, FaJava, FaChartBar, FaChartLine } from 'react-icons/fa';
...
import cert1 from '../assets/certificates/ML.png';
  ...
  const certificates = [
    {
      ...
      date: "2024",
      icon: <SiTensorflow className="text-[#FF6F00]" size={24} />, // Changed icon to SiTensorflow
      image: cert1,
    },
    // {
    //   id: 2,
